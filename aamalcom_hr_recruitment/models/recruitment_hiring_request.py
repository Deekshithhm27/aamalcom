...
class HiringRequest(models.Model):
    ...
    state = fields.Selection([
        ('draft', 'Draft'),
        ('submitted', 'Submitted'),
        ('recruiter_approved', 'Recruitment Officer Approved'),
        ('recruiter_rejected', 'Recruitment Officer Rejected'),
        ('admin_approved', 'Recruitment Administrator Approved'),
    ...
    def _open_reject_wizard(self, reject_state):
        return {
            ...
            'res_model': 'recruitment.hiring.request.reject.wizard',
            'view_mode': 'form',
            'target': 'new',
