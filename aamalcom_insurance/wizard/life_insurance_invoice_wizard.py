...
class LifeInsuranceInvoiceWizard(models.TransientModel):
    _name = 'life.insurance.invoice.wizard'
    _description = 'Life Insurance Invoice Wizard'
    ...
    def action_generate_invoice(self):
        ...
        enrollment_lines = self.env['life.insurance.invoice.details'].search(domain + [('insurance_type', '=', 'enrollment')])
        deletion_lines = self.env['life.insurance.invoice.details'].search(domain + [('insurance_type', '=', 'deletion')])
        ...
        for line in enrollment_lines:
            insurance_line_vals.append((0, 0, {
                ...
                'life_insurance_invoice_id':line.id
            }))
...
class LifeInsuranceInvoiceReportWizard(models.TransientModel):
    _name = 'life.insurance.invoice.report.wizard'
    _description = 'Life Insurance Report Print Wizard'
    ...
    def action_print_report(self):
        ...
        return self.env.ref('aamalcom_insurance.action_report_life_insurance_summary').report_action(self, data=data)
