...
class TemporaryWorkVisa(models.Model):
    _inherit = 'temporary.work.visa'


    @api.model
    def default_get(self,fields):
        res = super(TemporaryWorkVisa,self).default_get(fields)
        salary_lines = [(5,0,0)]
    ...
    client_salary_rule_ids = fields.One2many('salary.line', 'twv_visa_id', string="Salary Structure")
