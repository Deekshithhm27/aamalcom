# aamalcom_reporting/reports/qiwa_contract_report.py

from odoo import models, api, fields


class QiwaContractReport(models.AbstractModel):
    _name = 'report.aamalcom_reporting.qiwa_contract_report_template'
    _description = 'Qiwa Contract Report PDF'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        base_return_data = {
            'doc_ids': docids,
            'doc_model': 'qiwa.contract.report.wizard',
            'docs': [],
            'data': data,
            'from_date': from_date,
            'to_date': to_date,
            'service_request_type_fixed_label': 'Qiwa Contract',
        }
