...
class MedicalInsuranceClassChange(models.Model):
    _inherit = 'medical.insurance.class.change'

    def _schedule_ticket_activity_micc(self, user_id, summary, note):
        self.activity_schedule(
            act_type_xmlid='aamalcom_ticket_activity.mail_activity_type_ticket_micc_action',
            date_deadline=None,
            summary=summary,
            note=note,
            user_id=user_id
    ...
    def action_submit_to_pm(self):
        result = super(MedicalInsuranceClassChange, self).action_submit_to_pm()
    ...
    def action_done(self):
        result = super(MedicalInsuranceClassChange, self).action_done()
